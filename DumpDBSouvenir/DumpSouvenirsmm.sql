CREATE DATABASE  IF NOT EXISTS `souvenirsdbmm` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `souvenirsdbmm`;
-- MySQL dump 10.13  Distrib 8.0.20, for Win64 (x86_64)
--
-- Host: localhost    Database: souvenirsdbmm
-- ------------------------------------------------------
...
-- Dump completed on 2021-10-09  9:05:48
